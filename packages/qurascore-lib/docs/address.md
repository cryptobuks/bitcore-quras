...
The errors are listed in the generated file in the [errors folder](https://github.com/bitpay/qurascore/tree/master/packages/qurascore-lib/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/bitpay/qurascore/tree/master/packages/qurascore-lib/lib/errors/spec.js).
