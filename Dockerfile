...
COPY packages/bitcore-wallet-client-quras ./packages/bitcore-wallet-client-quras/package.json
...
COPY packages/crypto-wallet-core-quras ./packages/crypto-wallet-core-quras/package.json
